...
import br.com.qualitytecnologia.IntegrationTest;
import br.com.qualitytecnologia.domain.Blog;
import br.com.qualitytecnologia.repository.BlogRepository;
import br.com.qualitytecnologia.service.dto.BlogDTO;
import br.com.qualitytecnologia.service.mapper.BlogMapper;
...
class BlogResourceIT {
    ...
    public static Blog createEntity(EntityManager em) {
        Blog blog = new Blog().name(DEFAULT_NAME).handle(DEFAULT_HANDLE).status(DEFAULT_STATUS).description(DEFAULT_DESCRIPTION);
        return blog;
    }
    ...
    public static Blog createUpdatedEntity(EntityManager em) {
        Blog blog = new Blog().name(UPDATED_NAME).handle(UPDATED_HANDLE).status(UPDATED_STATUS).description(UPDATED_DESCRIPTION);
        return blog;
    }
    ...
    void createBlog() throws Exception {
        ...
        assertThat(testBlog.getStatus()).isEqualTo(DEFAULT_STATUS);
    ...
    void putNewBlog() throws Exception {
        ...
        updatedBlog.name(UPDATED_NAME).handle(UPDATED_HANDLE).status(UPDATED_STATUS).description(UPDATED_DESCRIPTION);
        ...
        assertThat(testBlog.getStatus()).isEqualTo(UPDATED_STATUS);
    ...
    void partialUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.handle(UPDATED_HANDLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.name(UPDATED_NAME).handle(UPDATED_HANDLE).status(UPDATED_STATUS).description(UPDATED_DESCRIPTION);
